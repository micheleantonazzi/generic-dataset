...
class GeneratedSampleRegression(generic_dataset.generic_sample.GenericSample, metaclass=generic_dataset.sample_generator.MetaSample):
	def __init__(sample, label: float = 0.0):
		...
	def set_field_3(sample, value: int) -> GeneratedSampleRegression:
		"""
		...
		:type value: int
		:return: the GeneratedSampleRegression object
		:rtype: GeneratedSampleRegression
		"""
		...
	def get_field_3(sample) -> int:
		...
		"""
		...
	def set_bgr_image(sample, value: numpy.ndarray) -> GeneratedSampleRegression:
		"""
	...
	def get_pipeline_bgr_image(sample) -> generic_dataset.data_pipeline.DataPipeline:
		...
		"""
		...
	def set_rgb_image(sample, value: numpy.ndarray) -> GeneratedSampleRegression:
		"""
	...
	def get_pipeline_rgb_image(sample) -> generic_dataset.data_pipeline.DataPipeline:
		...
		"""
		...
	def set_label(sample, value: float) -> GeneratedSampleRegression:
		"""
	...
	def field_3_is_positive(sample) -> bool:
		...
	def save_field(sample, field_name: str, path: str, file_name: str) -> GeneratedSampleRegression:
		"""
		...
		"""
		...
	def load_field(sample, field_name: str, path: str, file_name: str) -> GeneratedSampleRegression:
		"""
		...
		"""
		...
	def release_all_locks(sample) -> GeneratedSampleRegression:
		"""
		Releases all locks related to all fields of the sample instance
		:return: GenericSample instance
		"""
		...
	def acquire_all_locks(sample) -> GeneratedSampleRegression:
		"""
	...
	def __exit__(sample, exc_type, exc_value, exc_traceback):
		...
	def __enter__(sample) -> GeneratedSampleRegression:
		...
	...
